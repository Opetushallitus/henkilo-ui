...
const mapStateToProps = (state, ownProps) => ({
    muokkausoikeus: hasAnyPalveluRooli(state.omattiedot.organisaatiot, ['KOOSTEROOLIENHALLINTA_CRUD', 'HENKILONHALLINTA_OPHREKISTERI', 'KAYTTOOIKEUS_KAYTTOOIKEUSRYHMIEN_LUKU']),
